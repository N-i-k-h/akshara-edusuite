    ...
    try {
      ...
      const period = assignedPeriods.find(
        (p) =>
          ...
          p.period === parseInt(selectedPeriod),
      );
                ...
                >
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      <span>
                        {[
                          ...new Set(classInfo.periods.map((p) => p.subject)),
                        ].join(", ")}
                      </span>
                    </div>
                    <Button className="w-full mt-2">Mark Attendance</Button>
                  </CardContent>
                </Card>
              ))}
            </div>
